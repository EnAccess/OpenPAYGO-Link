 ...
 * Description: STM8S register definitions. Special thanks to Georg
 *              Icking-Konert (https://github.com/gicking) & to Lujji
 *              (https://github.com/lujji) for providing register definitions
 *              and code examples for SMT8s targets.
 */
...
/* UID */
#define UID_BASE_ADDRESS        0x4865
#define UID_WXCL                _MEM_(UID_BASE_ADDRESS + 0x00)
#define UID_WXCH                _MEM_(UID_BASE_ADDRESS + 0x01)
#define UID_WYCL                _MEM_(UID_BASE_ADDRESS + 0x02)
#define UID_WYCH                _MEM_(UID_BASE_ADDRESS + 0x03)
#define UID_WN                  _MEM_(UID_BASE_ADDRESS + 0x04)
#define UID_LN1                 _MEM_(UID_BASE_ADDRESS + 0x05)
#define UID_LN2                 _MEM_(UID_BASE_ADDRESS + 0x06)
#define UID_LN3                 _MEM_(UID_BASE_ADDRESS + 0x07)
#define UID_LN4                 _MEM_(UID_BASE_ADDRESS + 0x08)
#define UID_LN5                 _MEM_(UID_BASE_ADDRESS + 0x09)
#define UID_LN6                 _MEM_(UID_BASE_ADDRESS + 0x0A)
#define UID_LN7                 _MEM_(UID_BASE_ADDRESS + 0x0B)
...
/* Quick access to GPIO registers via PORT address */
#define PA      ((volatile PORT_t*) PA_BASE_ADDRESS)
#define PB      ((volatile PORT_t*) PB_BASE_ADDRESS)
#define PC      ((volatile PORT_t*) PC_BASE_ADDRESS)
#define PD      ((volatile PORT_t*) PD_BASE_ADDRESS)
#define PE      ((volatile PORT_t*) PE_BASE_ADDRESS)
#define PF      ((volatile PORT_t*) PF_BASE_ADDRESS)

/* Shortcut to read register bits */
#define reg_read_bit(_reg, _bit)    ((_reg & (1 << _bit)) >> _bit)
